...
class SubscriptionController extends Controller
{
    ...
    {
        $subscriptionTypes = SubscriptionType::all()->map(function ($subscriptionType) {
            return [
                'id' => $subscriptionType->id,
                'name' => $subscriptionType->label,
                'label' => $subscriptionType->label,
                'description' => $subscriptionType->description,
                'price' => $subscriptionType->price,
                'recurrence' => $subscriptionType->recurrence,
                'duration' => $subscriptionType->recurrence === 'monthly' ? 'mois' : 'trimestre',
    ...
    public function show($id)
    {
        ...
        return response()->json([
            'id' => $subscriptionType->id,
            'name' => $subscriptionType->label, // Map label to name for frontend compatibility
            'label' => $subscriptionType->label,
            'description' => $subscriptionType->description,
            'price' => $subscriptionType->price,
            'recurrence' => $subscriptionType->recurrence,
